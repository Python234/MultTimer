...
class Profile {
    ...
    void setName(String name) { this.nameProperty.set(name);}
    String getName() { return this.nameProperty.get(); }

    void setStartEndSound(String str) { this.startEndSound.set(str); }
    String getStartEndSound() { return this.startEndSound.get(); }

    void setPeriodicSound(String str) { this.periodicSound.set(str); }
    String getPeriodicSound() { return this.periodicSound.get(); }

    void setEndOfRestSound(String str) { this.endOfRestSound.set(str); }
    String getEndOfRestSound() { return this.endOfRestSound.get(); }

    void setRoundWarningSound(String str) { this.roundWarningSound.set(str); }
    String getRoundWarningSound() { return this.roundWarningSound.get(); }

    void setRoundColor(Color color) { this.roundColor.set(color); }
    Color getRoundColor() { return this.roundColor.get(); }

    void setWarningColor(Color color) { this.warningColor.set(color); }
    Color getWarningColor() { return this.warningColor.get(); }

    void setRestColor(Color color) { this.restColor.set(color); }
    Color getRestColor() { return this.restColor.get(); }

    IntegerProperty roundNumberProperty() { return this.numberOfRoundsProperty; }
    void setNumberOfRounds(int rounds) { this.numberOfRoundsProperty.set(rounds); }
    ...
    void setRoundTimeMin(int minutes) { this.roundTimeMinProperty.set(minutes); }
    ...
    void setRoundTimeSec(int seconds) { this.roundTimeSecProperty.set(seconds); }
    int getRoundTimeSec() { return this.roundTimeSecProperty.get(); }

    IntegerProperty restMinProperty() { return this.restTimeMinProperty; }
    void setRestTimeMin(int minutes) { this.restTimeMinProperty.set(minutes); }
    int getRestTimeMin() { return this.restTimeMinProperty.get(); }

    IntegerProperty restSecProperty() { return this.restTimeSecProperty; }
    void setRestTimeSec(int seconds) { this.restTimeSecProperty.set(seconds); }
    int getRestTimeSec() { return this.restTimeSecProperty.get(); }

    void setPrepareTimeMin(int minutes) { this.prepareTimeMinProperty.set(minutes); }
    int getPrepareTimeMin() { return this.prepareTimeMinProperty.get(); }

    void setPrepareTimeSec(int seconds) { this.prepareTimeSecProperty.set(seconds); }
    int getPrepareTimeSec() { return this.prepareTimeSecProperty.get(); }

    void setInnerPeriodicAlertMin(int minutes) { this.innerPeriodicAlertMinProperty.set(minutes); }
    int getInnerPeriodicAlertMin() { return this.innerPeriodicAlertMinProperty.get(); }

    void setInnerPeriodicAlertSec(int seconds) { this.innerPeriodicAlertSecProperty.set(seconds); }
    int getInnerPeriodicAlertSec() { return this.innerPeriodicAlertSecProperty.get(); }

    void setEndOfRoundAlertMin(int minutes) { this.endOfRoundAlertMinProperty.set(minutes); }
    int getEndOfRoundAlertMin() { return this.endOfRoundAlertMinProperty.get(); }

    void setEndOfRoundAlertSec(int seconds) { this.endOfRoundAlertSecProperty.set(seconds); }
    int getEndOfRoundAlertSec() { return this.endOfRoundAlertSecProperty.get(); }

    void setState(boolean state) { this.stateProperty.set(state); }
    boolean getState() { return this.stateProperty.get(); }

    void enableVoice(boolean enable) { this.voiceEnabledProperty.set(enable); }
    boolean isVoiceEnabled() { return this.voiceEnabledProperty.get(); }

    void alertEndOfRest(boolean value) { this.alertEndOfRest = value; }
